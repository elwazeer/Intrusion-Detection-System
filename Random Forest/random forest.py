...
clf_DoS=RandomForestClassifier(n_estimators=10,n_jobs=-1)
# clf_DoS.fit(X_DoS, Y_DoS.astype(int))
# Y_DoS_pred=clf_DoS.predict(X_DoS_test)

accuracy = cross_val_score(clf_DoS, X_DoS_test.astype(int), Y_DoS_test.astype(int), cv=10, scoring='accuracy')
print("Accuracy: %0.5f (+/- %0.5f)" % (accuracy.mean(), accuracy.std() * 2))
precision = cross_val_score(clf_DoS, X_DoS_test.astype(int), Y_DoS_test.astype(int), cv=10, scoring='precision')

...
df = pd.read_csv("KDDTrain+_20Percent.csv", header=None, names = col_names)
df_test = pd.read_csv("KDDTrain+_20Percent.csv", header=None, names = col_names)
...
f = cross_val_score(clf_SVM_DoS, X_DoS_test.astype(int), Y_DoS_test.astype(int), cv=10, scoring='f1')
